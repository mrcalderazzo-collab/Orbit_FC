...
// Seed timestamps are relative to "now" so the real SLA clock shows a believable
// spread (some fresh, some aging, a few breached) instead of everything breaching
// against stale fixed dates. h = hours ago.
