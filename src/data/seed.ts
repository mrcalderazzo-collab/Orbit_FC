...
export const TICKETS: Ticket[] = [
  ...
  { id: "T-4790", title: "Renew master insurance — binder expires 06/30", building: "b1", type: "Documents", prio: "High", status: "Open", assignee: null, requester: "AI · Lease Engine", created: "2026-06-05T08:00:00", desc: "Master property policy lapses in 22 days. AURA RPG quote attached for board review.", verified: true, log: [["2026-06-05T08:00", "nick", "AI surfaced renewal window"]] },
...
export const AI_RECS: AiRec[] = [
  { id: "ai1", kind: "Maintenance triage", building: "b2", confidence: 0.94, status: "pending", agent: "TRIAGE_ENGINE", rec: "Escalate elevator ticket T-4801 to Critical and notify board.", reason: "3 tenant reports in 6h + Otis fault code 0x4F historically precedes full outage in 71% of cases.", input: "Sensor log: car B, floors 7–9, fault recurrence 11×/24h." },
  ...
  { id: "ai3", kind: "Financial anomaly", building: "b4", confidence: 0.97, status: "pending", agent: "ANOMALY_ENGINE", rec: "Hold payment on two Mold Agent Inc invoices pending review.", reason: "Duplicate line items detected across INV-2204 and INV-2211, $3,180 overlap.", input: "OCR diff on PDF invoices; QuickBooks match 0.93." },
  { id: "ai4", kind: "Lease renewal", building: "b1", confidence: 0.82, status: "pending", agent: "LEASE_ENGINE", rec: "Begin master insurance renewal — binder expires in 22 days.", reason: "Policy ORBIT001-MP lapses 06/30. AURA RPG quote 6% under current premium.", input: "Policy registry + AURA quote PDF." },
  { id: "ai5", kind: "Document review", building: "b6", confidence: 0.76, status: "approved", agent: "DOC_ENGINE", rec: "Flag bylaw section 4.2 for counsel — conflicts with co-purchasing request.", reason: "Semantic conflict between board request and recorded bylaws v3.", input: "Bylaws v3 §4.2 vs board request T-4782." },
];
