...
export const AI_RECS: AiRec[] = [
  ...
  { id: "ai4", kind: "Lease renewal", building: "b1", confidence: 0.82, status: "pending", agent: "LEASE_ENGINE", ticketId: "T-4790", rec: "Begin master insurance renewal — binder expires in 22 days.", reason: "Policy ORBIT001-MP lapses 06/30. AURA RPG quote 6% under current premium.", input: "Policy registry + AURA quote PDF." },
