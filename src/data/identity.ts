...
export const USERS: OrbitUser[] = [
  ...
  { id: "u_dispatch", persona: "operator", who: "coord", role: "dispatch", title: "Front Desk Dispatcher", email: "o.frey@orbit.ops", scope: "Central intake · routes all incoming", home: "tickets", perms: ["dashboard", "tickets", "comms", "buildings", "vendors"] },
