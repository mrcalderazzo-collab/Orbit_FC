...
export const USERS: OrbitUser[] = [
  ...
  { id: "u_priya", persona: "operator", who: "cait", title: "Compliance & Admin", email: "p.anand@orbit.ops", scope: "Portfolio · compliance & finance", home: "tickets", perms: ["dashboard", "tickets", "buildings", "notices", "ai"] },
  { id: "u_diego", persona: "operator", who: "luke", title: "Field Intelligence", email: "d.ramos@orbit.ops", scope: "Field queue · NYC Ops", home: "tickets", perms: ["tickets", "buildings", "emergencies"] },
