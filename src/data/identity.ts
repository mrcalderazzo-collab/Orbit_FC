...
export const USERS: OrbitUser[] = [
  ...
  { id: "u_diego", persona: "operator", who: "luke", role: "field", title: "Field Manager", email: "d.ramos@orbit.ops", scope: "Field queue · NYC Ops", home: "dashboard", perms: ["dashboard", "planner", "tickets", "comms", "buildings", "emergencies", "vendors"] },
  { id: "u_gina", persona: "operator", who: "gidi", role: "am", title: "Account / Property Manager", email: "s.klein@orbit.ops", scope: "Hawthorne · Vesper · Calloway", home: "dashboard", perms: ["dashboard", "planner", "tickets", "comms", "buildings", "notices", "finance"] },
  { id: "u_dana", persona: "operator", who: "dana", role: "manager", title: "Operations Manager", email: "d.brooks@orbit.ops", scope: "Ops · queue & vendors", home: "dashboard", perms: ["dashboard", "planner", "live", "tickets", "comms", "buildings", "compliance", "vendors", "reports", "datacenter", "ai"] },
  { id: "u_dispatch", persona: "operator", who: "coord", role: "dispatch", title: "Front Desk Dispatcher", email: "o.frey@orbit.ops", scope: "Central intake · routes all incoming", home: "dashboard", perms: ["dashboard", "tickets", "comms", "buildings", "vendors"] },
