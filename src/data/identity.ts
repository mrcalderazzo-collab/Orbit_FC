...
export const USERS: OrbitUser[] = [
  ...
  { id: "u_dana", persona: "operator", who: "dana", role: "manager", title: "Operations Manager", email: "d.brooks@orbit.ops", scope: "Ops · queue & vendors", home: "dashboard", perms: ["dashboard", "planner", "live", "tickets", "comms", "buildings", "compliance", "playbooks", "vendors", "reports", "datacenter", "ai"] },
